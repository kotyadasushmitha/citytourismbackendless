...
// This class is a playground -- It doesn't integrate with our model,
// but it can be used to easily create some cities and tourist sites to populate the Be app
...
class SavingViewController: UIViewController {
    ...
    //shows how to save cities and make relations synchronously
